...
```sh
curl -q -fL https://github.com/xch3177-publicrepo/RealDefect-R/archive/refs/tags/public-v1.0.0-20260916.tar.gz -o realdefect-r-public-v1.0.0-20260916.tar.gz
mkdir realdefect-snapshot
tar -xzf realdefect-r-public-v1.0.0-20260916.tar.gz --strip-components=1 -C realdefect-snapshot
