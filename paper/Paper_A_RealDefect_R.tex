...
Fig. 3 shows joint summary-disagreement patterns by split and identity disagreement by source group. The frame checks and controlled consumer replay below address distinct relations.\par
...
The minimal, sanitized replay package is available at \url{https://github.com/xch3177-publicrepo/RealDefect-R}, fixed version \texttt{public-v1.1.0-20260919} \cite{13}. The release provides a downloadable snapshot, per-file SHA-256 manifest and archive checksums. It contains the case registry and runners, projected inputs and small fixtures, GX experiment, RD8 diagnostic, Cosmos audits including C5 and the consumer replay, figure sources, protocols and retained outcomes. \texttt{REPRO.md} provides an unauthenticated retrieval command and separates offline integrity checks from fresh-input execution, including a short native-GX replay. RD8's expected scientific negative is distinguished from infrastructure failure. Private work paths, contact details, review correspondence and unrelated development records are excluded; upstream source identities and attribution are retained.\par

The linked \href{https://github.com/xch3177-publicrepo/RealDefect-R/releases/download/public-v1.0.1-20260919/PUBLIC_ACCESS_VERIFICATION.json}{replay receipt} records an unauthenticated run of \texttt{public-v1.0.1-20260919} on 19 September 2026: all 42 GX validation branches completed and all six frozen-result comparisons matched, using fresh input and run directories with a preinstalled dependency environment. The current revision retains the same replay code.\par
...
\bibitem{13} RealDefect-R contributors. Sanitized replay artifact, version \texttt{public-v1.1.0-20260919}, 2026. [Online]. Available: \url{https://github.com/xch3177-publicrepo/RealDefect-R/releases/tag/public-v1.1.0-20260919}.
